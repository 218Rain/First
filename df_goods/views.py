...
def index(request):
    ...
    fruit = GoodsInfo.objects.filter(gtype__id=1).order_by("-id")[:4]       # 最新的
    fruit2 = GoodsInfo.objects.filter(gtype__id=1).order_by("-gclick")[:4]  # 最热的
    ...
    context = {'title': '首页',
               ...
               'egg': egg, 'egg2': egg2,
               'vegetables': vegetables, 'vegetables2': vegetables2,
